...
export const Servicos = () => {
  return (
    <>
      <div className="relative h-screen font-Poppins z-10 text-white tracking-widest">
        ...
        <div className="w-[35vw] h-[35vw] flex flex-col rounded-full bg-gradient-to-b from-baby-blue to-blue-portfolio relative opacity-5 shadow-black shadow-xl top-0 mt-[-120vh] ml-[20vw] left-[0]"></div>
      </div>
    </>
  );
};
