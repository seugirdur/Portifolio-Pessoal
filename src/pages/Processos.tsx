      ...
      <div className="relative flex flex-col h-screen font-Poppins z-10 text-white ">
        <div className="flex flex-col">
          ...
          <div className="flex lg:flex-row flex-col w-full">
            ...
            <div className="lg:w-1/2 flex flex-col z-10 h-full justify-evenly">
              <div className="w-full flex justify-center">
                <div className="lg:w-40 lg:h-40 w-20 h-20 rounded-full flex items-center justify-center my-4  bg-black">
                  <div className="lg:w-36 lg:h-36 w-16 h-16 rounded-full items-center justify-center flex bg-black-portfolio">
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-base lg:text-xs">Código</p>
                    </div>
                  </div>
                </div>
              </div>
              <div className="flex flex-row w-full justify-evenly my-4">
                <div className="lg:w-128 lg:h-104 w-64 h-40  flex rounded-full -z-10 absolute self-center ring-1 ring-white"></div>
                ...
                <div className="lg:w-40 lg:h-40 w-20 h-20 rounded-full flex items-center my-4 justify-center  bg-white">
                  <div className="lg:w-36 lg:h-36 w-16 h-16 rounded-full items-center justify-center flex bg-black-portfolio">
                    <div className="flex flex-col items-center justify-center ">
