...
export const ProjectCard = ({ key }: ProjectCardProps) => {
  ...
  return (
    <div className="m-2 pb-8 w-96 justify-center items-center flex flex-col ring-4 rounded-3xl ring-lightblue-portfolio">
      ...
      <p className="text-3xl p-2">Detalhes do projeto, detalhes do projeto</p>
